      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 h-full">
        <div className="flex justify-between items-center h-full">
          ...
          <div className="hidden md:flex flex-grow justify-center px-4 max-w-3xl">
            <div className="w-full relative bg-white/10 rounded-2xl flex items-center overflow-hidden border border-white/20 backdrop-blur-md shadow-inner">
              <Search className="h-4 w-4 text-white/70 absolute left-5" />
              <input
                type="text"
